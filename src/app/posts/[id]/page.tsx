        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900">
            <article>
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-gray-600 dark:text-gray-400">
                            ...
                            {post.updatedAt !== post.createdAt && (
                                <span className="text-sm">(수정됨: {new Date(post.updatedAt).toLocaleDateString("ko-KR")})</span>
                            )}
                        </div>
                    </div>
                ...
                <div className="prose dark:prose-invert max-w-none mb-12 prose-lg">
                    <div dangerouslySetInnerHTML={{__html: post.content}} className="ck-content text-gray-900 dark:text-gray-100" />
                </div>
